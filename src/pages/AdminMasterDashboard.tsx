...
export default function AdminMasterDashboard() {
  ...
  type ClinicSettingsData = {
    ...
    agenda:         { start_hour: string; end_hour: string; slot_minutes: number; calendar_prefix: string; daily_reminder_whatsapp: boolean; finance_admin_phone: string };
  ...
  const openClinicSettings = async (clinic: Clinic) => {
    ...
    try {
      ...
      if (data.settings) {
        ...
        setSettingsData({
          ...s,
          agenda:         { start_hour:'08:00', end_hour:'19:00', slot_minutes:60, calendar_prefix:'', daily_reminder_whatsapp:false, finance_admin_phone:'', ...(s.agenda||{}) },
      ...
      {userModal.open && (
        <Modal title={userModal.userId ? 'Editar Usuario' : 'Nuevo Usuario'} onClose={() => setUserModal({ open: false })}>
          <div className="space-y-4">
            ...
            {/* Datos profesionales para fichas clínicas */}
            <div className="border-t border-gray-100 pt-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input type="text" value={userForm.especialidad} onChange={e => setUserForm(p => ({ ...p, especialidad: e.target.value }))} placeholder="Ej: Medicina Estética" className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#deb887]/40 focus:border-[#deb887] focus:outline-none" />
                </div>
              </div>
            </div>
