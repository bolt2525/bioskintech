...
export async function initMultiTenantSchema() {
  ...
  // Auditoría global del bot de WhatsApp — consulta exclusiva de master_admin
  await sql`
  ...
  await sql`CREATE INDEX IF NOT EXISTS idx_whatsapp_messages_appointment ON whatsapp_messages(appointment_event_id, appointment_start) WHERE appointment_event_id IS NOT NULL`;
