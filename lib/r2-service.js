 ...
 */
export async function generateUploadUrl(r2Key, contentType, contentLength, expiresIn = 300) {
  if (!Number.isInteger(contentLength) || contentLength < 1 || contentLength > 4 * 1024 * 1024) {
    throw new Error('contentLength debe estar entre 1 y 4 MB');
  }
