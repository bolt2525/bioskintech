...
export async function recordWhatsAppMessage({
  ...
  return sql`
    INSERT INTO whatsapp_messages
      (contact_id, direction, content, media_type, occurred_at, status, provider_message_id, error_detail, booked_by_user_id)
    VALUES
      (${contact.rows[0].id}, ${direction}, ${safeContent}, ${mediaType}, ${occurredAt}, ${status}, ${providerMessageId}, ${safeError}, ${bookedByUserId})
